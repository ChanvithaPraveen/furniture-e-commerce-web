...
import { Box, Grid, Typography, Button, TextField, IconButton, Paper } from "@mui/material";
...
const ProductsPage = () => {
  ...
  // Filter products by search term (this is for illustration)
              ...
              <Grid item xs={12} sm={6} md={4} key={product.id}>
                <Paper
                  sx={{
                    ...
                    minHeight: "450px", // Fix the height to make cards uniform
